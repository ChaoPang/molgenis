...
public class OntologyTagServiceTest extends AbstractMolgenisSpringTest
{
	...
	public void testgetTagsForAttribute()
	{
		...
		when(dataService.findOneById(ENTITY_TYPE_META_DATA, "org.molgenis.SNP", EntityType.class))
	...
	public void testAddAttributeTag()
	{
		...
		SemanticTag<Attribute, OntologyTagObject, Ontology> chromosomeTag = new SemanticTag<>("1233", attribute,
				instanceOf, CHROMOSOME_NAME_ONTOLOGY_TERM, EDAM_ONTOLOGY);
	...
	public void testRemoveAttributeTag()
	{
		...
		SemanticTag<Attribute, OntologyTagObject, Ontology> geneAnnotationTag = new SemanticTag<>("4321", attribute,
	...
	public void testRemoveAllTagsFromEntity()
	{
		...
		when(dataService.findOneById(ENTITY_TYPE_META_DATA, "test", EntityType.class)).thenReturn(entityTypeEntity);
	...
	public void testTagAttributesInEntity()
	{
		...
		Map<Attribute, OntologyTagObject> tags = Maps.newHashMap();
