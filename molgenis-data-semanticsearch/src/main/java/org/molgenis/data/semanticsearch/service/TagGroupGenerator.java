...
{
	public abstract List<TagGroup> findTagGroups(AttributeMetaData attributeMetaData,
	...
	public abstract List<TagGroup> generateTagGroups(Set<String> queryWords,
			List<TagGroup> relevantOntologyTermHits);
