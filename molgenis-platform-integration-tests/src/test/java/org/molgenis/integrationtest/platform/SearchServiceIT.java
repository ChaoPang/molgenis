	...
	public void testSemanticSearch()
	{
		...
		List<Set<ExplainedQueryString>> expectedExplanationStrings = asList(
				...
				singleton(ExplainedQueryString
						.create("high", "high pressur blood", "hypertension", (float) 41.66666666666667)),
				// And now for something completely different...
				emptySet(),
				// Are you taking hypertensive medication?
				singleton(ExplainedQueryString.create("hypertens", "hypertens", "hypertension", (float) 100.0)),
				// Have you ever had high blood pressure? (Repeat) (1)
				singleton(ExplainedQueryString
						.create("high pressur blood", "high pressur blood", "hypertension", (float) 100.0)),
				// Do you suffer from Ocular hypertension?
				singleton(ExplainedQueryString
						.create("ocular hypertens", "ocular hypertens", "hypertension", (float) 100.0)),
