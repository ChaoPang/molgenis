...
public class SemanticSearchServiceHelperTest extends AbstractMolgenisSpringTest
{
	...
	public void testCreateShouldQueryRule()
	{
		...
		OntologyTerm ontologyTerm_1 = OntologyTerm
				.create("1", "http://www.molgenis.org/1", "molgenis label in the gcc");
		OntologyTerm ontologyTerm_2 = OntologyTerm
				.create("2", "http://www.molgenis.org/2", "molgenis label 2 in the genetics", singletonList("label 2"));
	...
	public void testCollectQueryTermsFromOntologyTerm()
	{
		...
		OntologyTerm ontologyTerm3 = OntologyTerm
				.create("3", "http://onto/standingheight-children", "length", singletonList("body_length"));

		when(ontologyService.getChildren(ontologyTerm2, OntologyTermRepository.DEFAULT_EXPANSION_LEVEL))
				.thenReturn(singletonList(ontologyTerm3));
